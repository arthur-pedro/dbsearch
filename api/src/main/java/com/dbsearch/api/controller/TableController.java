...
public class TableController {
    ...
    public ResponseEntity<List<TableInfoDTO>> findTableNames(HttpServletRequest request, @RequestParam String schema) throws Exception {
    ...
    public ResponseEntity<TableInfoDTO> findTableColumns(HttpServletRequest request, @PathVariable("tableName") String tableName, @RequestParam String schema) throws Exception {
